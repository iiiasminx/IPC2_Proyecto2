 ...
 * @author Yásmin
 */
public class CargarRepuestos1 extends javax.swing.JFrame {

    /**
     * Creates new form CargarRepuestos1
     */
    public CargarRepuestos1() {
        initComponents();
    }
    ...
    private void EscogerArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EscogerArchivoActionPerformed
        ...
        FileFilter filtro = new FileNameExtensionFilter("Archivos TMR (*.tmr)", "tmr");
...
//                TallerMecánico.contandingRepuestos = 0;
                
//                String hola = String.valueOf(sc.nextLine());
//                System.out.println(hola);
                ...
                while (sc.hasNextLine()) {
                    ...
                    // AQUI CREO LA LISTA DE UNA
                    
                    int existencias = Integer.parseInt(lineacodigo[3]);
                    float precio = Float.valueOf(lineacodigo[4].trim());

                    ObjRepuestos obj1 = new ObjRepuestos(TallerMecánico.contandingRepuestos, 
                            lineacodigo[0], lineacodigo[1],
                        lineacodigo[2], existencias, precio);

                    TallerMecánico.l2.apilar(obj1);
                    TallerMecánico.contandingRepuestos++;
                    
                    TallerMecánico.tablitaRepuestos.insertRow(0, new Object[] {obj1.getId(),
                obj1.getNombre(), obj1.getMarca(), obj1.getModelo(), obj1.getExistencias(),
                obj1.getPrecio()}); 
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargarRepuestos1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargarRepuestos1().setVisible(true);
            }
        });
    }
