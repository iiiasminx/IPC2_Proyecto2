...
public class CargarServicios extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CargarServicios
     */
    ...
    private void EscogerArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EscogerArchivoActionPerformed
        ...
        FileFilter filtro = new FileNameExtensionFilter("Archivos TMS (*.tms)", "tms");
        ...
        if (opcion == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                while (sc.hasNextLine()) {
                    ...
                    String[] repuestos = lineacodigo[3].split(";");
                    TallerMecánico.l5 = new ListaNormal();
                    
                    for (int i = 0; i < repuestos.length; i++) {
                        TallerMecánico.l5.apilar(Integer.parseInt(repuestos[i]));                        
                    }
                    System.out.println("Imprimiendo pila de repuestos");
                        TallerMecánico.l5.imprimir();
                    System.out.println("fin");
                    // AQUI CREO LA NORMAL DE UNA
                    
                    float manodeObra = Float.parseFloat(lineacodigo[4]);
                    
                    ObjServicios obj1 = new ObjServicios(TallerMecánico.contandingServicios,
                            lineacodigo[0], lineacodigo[1],
                        lineacodigo[2], TallerMecánico.l5, manodeObra );
                    
                    obj1.setStringLista(lineacodigo[3]);

                    TallerMecánico.l3.agregar(obj1);
                    TallerMecánico.contandingServicios++;
                    
                    TallerMecánico.tablitaServicios.addRow(new Object[] {obj1.getId(), 
                    obj1.getNombre(), obj1.getMarca(), obj1.getModelo(), lineacodigo[3], 
                    obj1.getPrecio(), obj1.getPrecio()});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargarServicios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargarServicios().setVisible(true);
            }
        });
    }
